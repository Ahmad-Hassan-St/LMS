                                    ...
                                    <div class="col-lg-4">
                                        <div class="card mb-4">
                                            <div class="card-body text-center">
                                                <img src="../Images/<?php if ($row['picture'] == "") {
                                                                        echo 'Missing.jpeg';
                                                                    } else {
                                                                        echo $row['picture'];
                                                                    } ?>" alt="avatar" class="mb-2 rounded-circle img-fluid" style="width: 150px;">
                                                <h5 class="my-2 mb-4"><?php echo $row['Name']; ?></h5>
                                                <div class="d-flex justify-content-center mb-1">
                                                    <button type="button" onclick="window.location.href='UpdateProfile.php'" class="btn btn-outline-danger ms-1">Update
                                                        Details</button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mb-4">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <p class="text-muted mb-0"><?php echo $row['batch']; ?></p>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <p class="mb-0">Degree Title</p>
                                                        </div>
                                                        <div class="col-sm-9">
                                                            <p class="text-muted mb-0"><?php echo $row['degree']; ?></p>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
