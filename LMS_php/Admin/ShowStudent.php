...
// 
            ...
            echo "<tr >
                ...
                <td> <button type='button' class='btn btn-primary btn-sm'><a href='updateStudent.php?studentID=".$row['ID']."' class='Text-light'>Update</a>
                </button>
                     <button type='button' class='btn btn-danger btn-sm'><a href='DeleteStudent.php?studentID=".$row['ID']."' class='Text-light'>Delete</a></button>
