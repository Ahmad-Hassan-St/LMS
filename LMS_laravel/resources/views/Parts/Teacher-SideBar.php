<div class="col-sm-2">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark position-fixed" style="width: 17%; height: 100vh;">
        <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            ...
            <span class="fs-4">Faculty Portal</span>
        </a>
        <hr>
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="EnrolledStudents.php" id="addcoursesprofile" class="nav-link text-white">
                    <svg class="bi pe-none me-2" width="16" height="16">
            ...
            <li>
                <a href="AddMarks.php" id="addmarks" class="nav-link text-white">
                    <svg class="bi pe-none me-2" width="16" height="16">
                        <use xlink:href="#table" />
                    </svg>
                     Add Marks
